    ...
    return (
        <section className="bg-white py-20">
            <div className="container px-6 py-10 mx-auto">
                ...
                <h1 className="text-3xl font-semibold text-center text-gray-800 capitalize lg:text-5xl ">Explore Our  Main <br /><span className="text-emerald-500"> Service</span></h1>

                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-4">

                    {
                        servicesData.map(service => {
                            return <div key={service.id} className="flex flex-col items-center p-6 space-y-3 text-center bg-emerald-50 rounded-xl hover:shadow-lg">
                                <span className="inline-block p-4 text-emerald-400 bg-emerald-100 rounded-full ">
                                    <div className='text-6xl' >
                                        {service.icon}
                                    </div>
                                </span>

                                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">{service.name}</h1>

                                <p className="text-gray-500 dark:text-gray-300">
                                    {service.info}
                                </p>

                                <Link to="/" className="flex items-center -mx-1 text-sm text-emerald-400 capitalize transition-colors duration-300 transform hover:underline hover:text-emerald-500 ">
