...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-blue-600 text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <Link rel="noopener noreferrer" to="/" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">Vision Health Center</span>
                    </Link>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase dark:text-gray-50">Pages</h3>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-400">Copyright © Developed by Md Hamimul Haque</div>
        </footer>
    );
};
