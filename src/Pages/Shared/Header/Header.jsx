...
const Header = () => {
    ...
    return (
        <div class="px-2 py-3 lg:px-5 z-50 bg-emerald-300">
            <div class="relative flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <ul class="flex items-center hidden space-x-8 lg:flex ml-4">
                ...
                <ul class="flex items-center hidden space-x-3 lg:flex">
                    <li>
                        <Link
                            to="/login"
                            class="px-4 py-3 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80"
                        >
                            Log in
                        </Link>
                    </li>
                        ...
                        <div class="absolute top-0 left-0 w-full z-50">
                            <div class="p-5 bg-white border rounded shadow-sm">
                                ...
                                <nav>
                                    ...
                                    <siv className='flex gap-2 mt-4 justify-center'>
                                        <Link
                                            to="/login"
                                            class="px-4 py-3 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80"
                                        >
