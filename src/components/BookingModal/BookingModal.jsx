                    ...
                    <div className="2xl:container  2xl:mx-auto py-14 px-4 md:px-28 flex justify-center items-center">
                        <div className="w-96 md:w-auto  relative flex flex-col justify-center items-center bg-white py-16 px-4 md:px-24 xl:py-24 xl:px-36">
                            ...
                            <form className='w-[320px] px-2'>
                                ...
                                <div className="mb-5">
                                    <select id="countries" className="bg-gray-50 border border-emerald-300 text-[#6B7280]  text-sm rounded-lg focus:ring-emerald-400 focus:border-emerald-500 block w-full p-2.5"
                                    >
                                        {
                                            slots.map(slot =>
                            ...
                            <button onClick={handleModalClose} className="text-gray-800 dark:text-gray-400 absolute top-8 right-8 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800" aria-label="close">
